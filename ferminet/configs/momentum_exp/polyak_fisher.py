"""C2H4 Polyak config: momentum, Fisher-norm clipping."""
...
def get_config() -> ml_collections.ConfigDict:
  cfg = c2h4.get_config()
  run_name = os.environ.get('FERMINET_RUN_NAME', 'c2h4_B_polyak_fisher')

  cfg.log.save_path = f'./runs/{run_name}'
  cfg.log.use_wandb = True
  cfg.log.wandb.name = run_name
  cfg.log.wandb.project = 'psiformer'
  cfg.log.wandb.notes = 'B_polyak_fisher C2H4 momentum ablation'
