...
def default() -> ml_collections.ConfigDict:
  ...
  cfg = ml_collections.ConfigDict({
      ...
      'optim': {
          ...
          'optimizer': 'kfac',  # one of adam, kfac, none
          ...
          'kfac': {
              ...
              # If true, clip L2 norm of preconditioned gradient instead of Fisher norm
              'constrain_l2': False,
          },
      ...
      'log': {
          ...
          # walker at each step
          'features': False,
          # Whether to use Weights & Biases (wandb) for experiment tracking
          'use_wandb': True,
          # wandb configuration options
          'wandb': {
              'project': 'ferminet',  # wandb project name
              'name': 'test',  # run name (if None, wandb will generate one)
              'tags': [],  # list of tags for the run
              'notes': 'default',  # notes for the run
          },
      },
      'eval': {
      ...
      'mcmc': {
          ...
          # MCMC algorithm: 'mh' (Metropolis-Hastings), 'mala', or 'mala_sign'
          'algorithm': 'mh',
          # Target acceptance for MALA adaptive step size
          'mala_target_acceptance': 0.57,
      },
      'network': {
          'psiformer': {
          ...
          # One of 'default', 'none', or 'simple_ee'.
          'jastrow': 'default',
